...
App=(function() {
    var App=function() {
        ...
        var datepicker_args = { dateFormat: 'dd-mm-yy' };
        
        $('#date_from').datepicker(datepicker_args).val('01-07-2016');
        $('#date_to').datepicker(datepicker_args).val('01-12-2016');
    ...
    App.prototype.load=function() {
        ...
        $.get(Urls['netvis-data'](), params, function(res) {
    ...
    App.prototype.node_on_mouseup=function(d) {
        ...
        $.get(Urls['netvis-graphinfo'](), params, this.set_graph_info_values.bind(this));
    }

    App.prototype.set_graph_info_values=function(res) {
        if(res._type=='error') {
            alert(res.message);
            return;
        }
